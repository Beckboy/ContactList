package com.example.hunter_j.contactlistactivity.view;
...
import com.example.hunter_j.contactlistactivity.ClassGroupChatContactListAdapter;
import com.example.hunter_j.contactlistactivity.R;
import com.example.hunter_j.contactlistactivity.entity.ClassGroupChatDetailsEntity;
import com.example.hunter_j.contactlistactivity.entity.ClassGroupChatDetailsListEnitity;
import com.example.hunter_j.contactlistactivity.utils.HanziToPinyin;
...
//    };
    ...
    public void init(List<ClassGroupChatDetailsEntity> contactList){
        ...
        Log.i("log",contactList.toString());
    ...
    private void setMap(String letter, ClassGroupChatDetailsEntity classGroupChatDetailsEntity) {
        ...
        for (int i = 0;i < contactslist.size();i++) {
            ...
            if (a<=c) {
                ...
                Log.i("log","add contactslist:"+groupList.english+":"+groupList.list.toString());
                return;
            }
        }
